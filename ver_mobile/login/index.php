...
<style>
  ...
  <button class="btn btn-lg btn-primary btn-block" id="logabtn" type="submit" style="width:250px; margin-left:60px; text-align: center; width:350px;">Logar</button>
    <div class="btnsa">

    <a href="../registro/index.php" class="loga" style="margin-left:30px;">Cadastrar</a>
